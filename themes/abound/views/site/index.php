...
$gridDataProvider = new CArrayDataProvider(array(
    array('id'=>1, 'searchTerm'=>'كيا', 'algorithmType'=>'Exact Match', 'no'=>'1285','freq'=>'<span class="inlinebar">1,3,4,5,3,5</span>'),
    array('id'=>2, 'searchTerm'=>'مرسيدس', 'algorithmType'=>'Exact Match', 'no'=>'642','freq'=>'<span class="inlinebar">1,3,16,5,12,5</span>'),
    array('id'=>3, 'searchTerm'=>'هوندا سيفيك', 'algorithmType'=>'Exact Match', 'no'=>'1853','freq'=>'<span class="inlinebar">1,4,4,7,5,9,10</span>'),
	array('id'=>4, 'searchTerm'=>'مطاعم ابو سفيان', 'algorithmType'=>'Partial Match', 'no'=>'21','freq'=>'<span class="inlinebar">1,3,16,5,12,5</span>'),
    array('id'=>5, 'searchTerm'=>'مطغم', 'algorithmType'=>'Spell Checking', 'no'=>'0','freq'=>'<span class="inlinebar">1,3,4,5,3,5</span>'),
));
?>
  ...
  <div class="span3 ">
	<div class="stat-block">
	  <ul>
		...
		<li class="stat-count"><span>23,000</span><span>Weekly Searches</span></li>
  ...
  <div class="span3 ">
	<div class="stat-block">
	  <ul>
		...
		<li class="stat-count"><span>123,780</span><span>Monthly Searches</span></li>
  ...
  <div class="span3 ">
	<div class="stat-block">
	  <ul>
		...
		<li class="stat-count"><span>0.74</span><span>Precision</span></li>
  ...
  <div class="span3 ">
	<div class="stat-block">
	  <ul>
		...
		<li class="stat-count"><span>0.69</span><span>Recall</span></li>
	...
	<div class="span6">
	  <?php $this->widget('zii.widgets.grid.CGridView', array(
			...
			'columns'=>array(
				...
				array('name'=>'searchTerm', 'header'=>'Search Terms'),
				array('name'=>'algorithmType', 'header'=>'Algorithm Type'),
				array('name'=>'no', 'header'=>'No. of Results'),
				array('name'=>'freq', 'header'=>'Freq.', 'type'=>'raw'),
